...
from module.its_analysis import ITSModelSARIMAX

print("=" * 80)
print("SARIMAX ハイパーパラメータチューニング改修テスト")
print("=" * 80)
...
# SARIMAXモデルのチューニングテスト
print("\n[2/2] SARIMAXモデルのチューニングテスト...")
print("  ※ 少ない試行回数で実行します（10回）")
...
try:
    ...
    # プラセボCVも実行してみる
    print("\n  プラセボCVも実行...")
    placebo_results = model_sarimax.placebo_cross_validate(
        cigar_model,
        target_column='sales',
        n_placebo_points=2
    )
    ...
    print(f"    - モデル妥当性: {'✅ OK' if placebo_results['is_valid'] else '⚠️ 要確認'}")
